#include "org_expand_ExpandToPosix.h"
...
void parseXPNStat (JNIEnv *env, struct stat *stats, jobject *obj){
	...
	jclass structObjClass = (*env)->FindClass(env, "org/expand/Stat");
...
JNIEXPORT jobject JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1createFlags
  (JNIEnv *env, jobject obj){
	...
	jclass fieldsClass = (*env)->FindClass(env, "org/expand/ExpandFlags");
	for (int i = 0; i < num_fields; i++){
...
JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1chdir
...
JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1chmod
...
JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1close
  (JNIEnv *env, jobject obj, jint fd){
        return xpn_close(fd);
}

JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1creat
...
JNIEXPORT jstring JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1getcwd
...
JNIEXPORT jobjectArray JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1getDirContent
...
JNIEXPORT jstring JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1getGroupname
...
JNIEXPORT jstring JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1getUsername
  (JNIEnv *env, jobject obj, jint id){
...
JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1init
  (JNIEnv *env, jobject obj){
	return xpn_init();
}

JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1isDir
  (JNIEnv *env, jobject obj, jint mode){

	return S_ISDIR(mode);
}

JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1lseek
  (JNIEnv *env, jobject obj, jint fd, jlong offset, jlong mode){
	return xpn_lseek(fd, (off_t) offset, (int) mode);
}

JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1mkdir
...
JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1open
...
JNIEXPORT jlong JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1read
...
JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1rename
...
JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1rmdir
  (JNIEnv *env, jobject obj, jstring path){
...
JNIEXPORT jobject JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1stat
  (JNIEnv *env, jobject obj, jstring path){
...
JNIEXPORT jint JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1unlink
  (JNIEnv *env, jobject obj, jstring path){
...
JNIEXPORT jlong JNICALL Java_org_expand_ExpandToPosix_jni_1xpn_1write
