...
import org.apache.spark.internal.io.{SparkHadoopWriterUtils, HadoopWriteConfigUtil, HadoopMapReduceCommitProtocol, HadoopMapRedCommitProtocol, FileCommitProtocol}
 ...
 */
private[spark]
object SparkExpandWriter extends Logging {
